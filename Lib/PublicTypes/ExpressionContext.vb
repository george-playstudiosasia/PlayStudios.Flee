...
Imports PlayStudios.Flee.CalcEngine
Imports System.IO
...
#Region "Methods - Internal"
	...
	Friend Function CloneInternal(ByVal cloneVariables As Boolean) As ExpressionContext
	    ...
	    context.MyProperties.SetValue("Options", Me.Options.SafeClone(context))
	    context.MyProperties.SetValue("ParserOptions", Me.ParserOptions.SafeClone(context))
