...
#Region "Methods - Internal"
    ...
    Friend Function SafeClone(ByVal owner As ExpressionContext) As ExpressionParserOptions
        Dim copy As ExpressionParserOptions = New ExpressionParserOptions(owner) With {
            .MyParseCulture = Me.MyParseCulture,
            .MyProperties = MyProperties.Clone()
        }
