...
#Region "Methods - Internal"
	Friend Function Clone(ByVal context As ExpressionContext) As ExpressionOptions
        return SafeClone(Me.MyOwner)
	End Function
    Friend Function SafeClone(ByVal context As ExpressionContext) As ExpressionOptions
        Dim clonedOptions As ExpressionOptions = Me.MemberwiseClone()
        clonedOptions.MyOwner = context
        clonedOptions.SetOwnerType(clonedOptions.MyOwner.GetType())
        clonedOptions.MyProperties = MyProperties.Clone()

        'remove event handler
        [Delegate].RemoveAll(clonedOptions.CaseSensitiveChangedEvent, clonedOptions.CaseSensitiveChangedEvent)
        Return clonedOptions
    End Function

    Friend Function CloneProperties(ByVal originalProperties As PropertyDictionary) As ExpressionOptions
        Dim clonedOptions As ExpressionOptions = Me
        clonedOptions.MyProperties = originalProperties.Clone()
        Return clonedOptions
    End Function
