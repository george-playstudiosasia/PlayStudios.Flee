...
Imports PlayStudios.Flee.PerCederberg.Grammatica.Runtime

'''<remarks>A character stream tokenizer.</remarks>
Friend Class ExpressionTokenizer
    Inherits Tokenizer

	Private MyContext As PlayStudios.Flee.ExpressionContext
	...
	Public Sub New(ByVal input As TextReader, ByVal context As PlayStudios.Flee.ExpressionContext)
